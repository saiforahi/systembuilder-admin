...
const CaseCoolers = () => {
    ...
    const casecoolers = useSelector(state =>{
        let temp=[]
        Array.from(state.caseCoolers.data).forEach((element,idx) => {
    ...
    const _delete=(casecooler_id)=>{
        console.log('id',casecooler_id)
        swal({
            title: "Are you sure?",
